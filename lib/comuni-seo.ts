...
const ctaCopy = [
  "Raccontami il progetto a {{comune}}: ti rispondiamo con una prima valutazione.",
...
const contattiTitle = [
  ...
  "Parla con la freelance web a {{comune}}",
  "Richiedi un sito a {{comune}} ({{sigla}})",
] as const;

const contattiLead = [
  "Contatti freelance web {{comune}}: raccontaci l’attività, il territorio e cosa vuoi ottenere online. Rispondiamo con una prima valutazione.",
...
const percheTitle = [
  ...
  "Freelance web a {{comune}}: perché noi",
