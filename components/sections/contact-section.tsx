    ...
    >
      <div className="mx-auto flex h-full w-full max-w-7xl flex-col items-center justify-center gap-6 lg:flex-row lg:gap-8">
        ...
        >
          ...
          <h2 className="text-[clamp(2rem,5.8vh,4.4rem)] font-bold leading-tight tracking-tight text-zinc-900">
            Pronto a <br className="hidden md:block"/>
            <span className="text-zinc-400">rinnovarti?</span>
          </h2>

          <p className="max-w-md text-[clamp(0.9rem,1.9vh,1rem)] text-zinc-600">
        ...
        >
          <div className="rounded-3xl border border-zinc-100 bg-zinc-50 p-5 md:p-6">
            <form onSubmit={onSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <label htmlFor="fullName" className="text-sm font-medium text-zinc-700 ml-1">
                  Nome e cognome
                </label>
                <input
                  id="fullName"
                  ...
                  className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 placeholder:text-zinc-400 transition-all focus:border-transparent focus:outline-none focus:ring-2 focus:ring-zinc-900"
                />
              </div>

              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="flex flex-col gap-2">
                  <label htmlFor="businessName" className="text-sm font-medium text-zinc-700 ml-1">
                    Nome attivita (facoltativa)
                  </label>
                  <input
                    id="businessName"
                    name="businessName"
                    type="text"
                    placeholder="Inserisci il nome della tua attivita"
                    className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 placeholder:text-zinc-400 transition-all focus:border-transparent focus:outline-none focus:ring-2 focus:ring-zinc-900"
                  />
                </div>

                <div className="flex flex-col gap-2">
                  <label htmlFor="phone" className="text-sm font-medium text-zinc-700 ml-1">
                    Numero di telefono
                  </label>
                  <input
                    id="phone"
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 placeholder:text-zinc-400 transition-all focus:border-transparent focus:outline-none focus:ring-2 focus:ring-zinc-900"
                />
              </div>

              <label className="flex items-start gap-3 rounded-xl border border-zinc-200 bg-white px-4 py-2 text-xs text-zinc-700 md:text-sm">
                <input
                  id="privacyAccepted"
              ...
              <button
                ...
                className="group relative mt-1 inline-flex h-11 w-full items-center justify-center overflow-hidden rounded-xl bg-zinc-900 px-6 text-sm font-medium tracking-wide text-zinc-50 transition-all hover:bg-zinc-800"
              >
