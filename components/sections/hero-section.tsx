...
export function HeroSection() {
  return (
    <section
      id="hero"
      className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden bg-zinc-50 px-6 py-[clamp(1rem,2.5dvh,2rem)] lg:px-24"
    >
      <div className="absolute bottom-0 right-8">
        <h1 className="brexon hidden md:block z-0 select-none text-left italic text-zinc-300 text-[16vw]">
          JADER
        </h1>
      </div>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-start text-left">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-widest text-zinc-600 md:text-xs">
              Web Developer & Designer • Udine, IT
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-[clamp(2.2rem,8.2vh,5.6rem)] font-bold leading-[1.02] tracking-tight text-zinc-900">
            Innovazione digitale <br className="hidden md:block" />
            <span className="text-zinc-500">su misura.</span>
          </h1>

          {/* Description */}
          <p className="mt-1 max-w-2xl text-[clamp(0.95rem,2.2vh,1.2rem)] leading-relaxed text-zinc-600">
          ...
          <div className="mt-4 flex flex-col items-center gap-3 sm:flex-row">
            ...
            <button 
              ...
              className="group relative z-10 inline-flex h-12 w-full items-center justify-center overflow-hidden rounded-full bg-zinc-900 px-6 text-sm font-medium tracking-wide text-zinc-50 transition-all hover:bg-zinc-800 sm:w-auto"
            >
            ...
            <button 
              ...
              className="z-10 inline-flex h-12 w-full items-center justify-center rounded-full border border-zinc-200 bg-zinc-50 px-6 text-sm font-medium text-zinc-900 transition-colors hover:border-zinc-300 hover:bg-zinc-100 sm:w-auto"
            >
              Esplora i lavori
            </button>
          </div>
      ...
      <motion.div 
        ...
        className="absolute bottom-4 left-1/2 hidden -translate-x-1/2 flex-col items-center gap-2 text-zinc-400 xl:flex"
      >
