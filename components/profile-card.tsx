  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(246, 245, 243, 0.18)",
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="group relative z-[1]">
        <section
          className="relative grid overflow-hidden border border-foreground text-foreground"
          style={{
            height: "80svh",
            maxHeight: "540px",
            aspectRatio: "0.718",
        ...
        >
          ...
          >
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element -- React Bits avatar with live CSS transforms */}
              <img
              ...
              {showUserInfo ? (
                <div
                  className="absolute z-[2] flex items-center justify-between border border-foreground/20 bg-background/80 backdrop-blur-[30px] pointer-events-auto"
                  style={
                    {
                      "--ui-inset": "20px",
                      "--ui-radius-bias": "6px",
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="flex-shrink-0 overflow-hidden rounded-full border border-foreground/20"
                      style={{ width: "48px", height: "48px" }}
                    >
                      {/* eslint-disable-next-line @next/next/no-img-element -- mini avatar from React Bits */}
                      <img
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      ...
                      <div className="text-sm leading-none text-foreground/70">{status}</div>
                    </div>
                  </div>
                  <button
                    className="cursor-pointer rounded-lg border border-foreground px-4 py-3 text-xs font-semibold text-foreground backdrop-blur-[10px] transition-all duration-200 ease-out hover:-translate-y-px hover:opacity-70"
            ...
            >
              ...
              >
                <h3
                  className="m-0 font-display font-semibold tracking-tight text-foreground"
                  style={{
                ...
                <p
                  className="mx-auto w-min whitespace-nowrap font-semibold text-foreground"
                  style={{
                    position: "relative",
                    top: "-12px",
                    fontSize: "16px",
